...
namespace survey
{
    public partial class SASolve : Form
    {
        ...
        private void SASolve_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
        ...
        {
            answer1 = answer_richtextbox_1.Text;
        }
        public void GetAnswer2()
        {
            answer2 = answer_richtextbox_2.Text;
        }
        private void SASolve_Load(object sender, EventArgs e)
        {
            FillQuestion();
        ...
        {
            answer3 = answer_richtextbox_3.Text;
        }
        public void GetAnswer4()
        {
            answer4 = answer_richtextbox_4.Text;
        }
        public void GetAnswer5()
        {
            answer5 = answer_richtextbox_5.Text;
        }
        ...
        public void FillQuestion()
        {
            ...
            string query = "select * from ShortAnswer where TypeId=3 and CategoryId=" + category + " and GroupId=" + g_id + " ";
        ...
        public void SaveAnswers()
        {
            ...
            {
                Login.db.Open();
                string query = "insert into Answers (QSAId, UserId, Answer, TypeId, CategoryId, GroupId) values (" + questionid[i] + ", " + userid + ",'" + answers[i] + "', " + 3 + ", " + category + ", " + g_id + ")";
                SqlCommand sqlCommand = new SqlCommand(query, Login.db);
